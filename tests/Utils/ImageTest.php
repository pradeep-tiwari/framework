...
class ImageTest extends TestCase
{
    ...
    public function testPadExpandsCanvasToTargetSize(): void
    {
        $outputPath = $this->outputDir . '/padded.png';
    ...
    public function testPadIsChainable(): void
    {
        $outputPath = $this->outputDir . '/padded_chain.png';
