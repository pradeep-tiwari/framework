...
class Str
{
    ...
    /**
     * This method will return the appropriate foreign key from the passed 
     * string making it suitable for use as a foreign key in databases.
     * 
     * For example: foreign('User') returns 'user_id'.
     */
